...
function editar(servicio_id){
    ...
    $.post("../../controller/servicio.php?op=mostrar", {servicio_id : servicio_id}, function (data) {
        data = JSON.parse(data);
        $('#servicio_id').val(data.servicio_id);
        $('#servicio_nom').val(data.servicio_nom);
    }); 
...
function eliminar(servicio_id){
    ...
    function(isConfirm) {
        if (isConfirm) {
            $.post("../../controller/servicio.php?op=eliminar", {servicio_id : servicio_id}, function (data) {
